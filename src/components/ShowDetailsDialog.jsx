...
import { Briefcase, Building2, Calendar, CheckCircle2, GraduationCap, Mail, Phone, Sparkles, Star, User, Award, MapPin, BadgePercent } from 'lucide-react';
...
const CustomerDetailsView = ({ data }) => (
    <Box sx={{ backgroundColor: "#f4f6f8", p: { xs: 1, md: 2 } }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 3 }}>
            <Avatar
                src={data.profilePicture || fallbackImage}
                alt={data.fullName}
